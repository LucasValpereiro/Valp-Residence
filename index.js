...
const APTS = [
    {
      ...
      highlights:['🔑 Self check-in com fechadura inteligente','🌿 Região tranquila e segura','☕ Café da manhã em casa'],
    ...
    },
    {
      ...
      highlights:['🔑 Self check-in com fechadura inteligente','🍽️ Ótimos restaurantes por perto','☕ Café da manhã em casa'],
    ...
    },
    {
      ...
      highlights:['🔑 Self check-in com fechadura inteligente','📍 Localização imbatível','☕ Café da manhã em casa'],
    ...
    },
    {
      ...
      highlights:['🔑 Self check-in com fechadura inteligente','🌿 Região tranquila','☕ Café da manhã em casa'],
    ...
    },
    {
      ...
      highlights:['🔑 Self check-in com funcionários do prédio','📍 Localização imbatível','☕ Café da manhã em casa'],
      rooms:[{name:'Quarto 1',beds:'1 cama queen'},{name:'Quarto 2',beds:'2 camas de solteiro'}],
      amenities:['🍳 Cozinha completa','📶 Wi-Fi fibra','💼 Espaço de trabalho','🚗 Estacionamento gratuito','🐾 Permitido animais','📺 TV','🛗 Elevador','🫧 Máquina de lavar'],
    ...
    },
    {
      ...
      highlights:['🔑 Self check-in com fechadura inteligente','📍 Localização adorada pelos hóspedes','☕ Café da manhã em casa'],
      rooms:[{name:'Quarto 1',beds:'1 cama queen'},{name:'Quarto 2',beds:'2 camas de solteiro'}],
    ...
    },
    {
      ...
      highlights:['🔑 Self check-in com teclado numérico','☕ Máquina de café expresso inclusa','💬 Ótima comunicação com o anfitrião'],
